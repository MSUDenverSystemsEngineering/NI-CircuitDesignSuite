...
Try {
	...
	[string]$appScriptAuthor = 'Quan Tran and Steve!'
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "$dirFiles\setup.exe" -Parameters "specfile /r:n /q /disableNotificationCheck /AcceptLicenses yes /groups `"`"" -WindowStyle 'Hidden' -IgnoreExitCodes '3010'
